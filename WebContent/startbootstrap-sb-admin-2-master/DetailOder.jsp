...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
  <%ServletContext contextChucNang = getServletContext();
    	contextChucNang.setAttribute("chucNang", "Xoa");
   %>
		...
		<div class="row"> 
			<div class="col-md-12"> 
				...
				<div class="panel panel-primary"> 
					...
					<h4>Tên người nhận : ${donHang.tenNguoiNhan} ,Số điện thoại : ${donHang.soDienThoai}</h4>
					 <h5>Ghi chú : ${donHang.ghiChu}</h5>
					...
					<table class="table table-hover" id="dev-table"> 
						...
						<c:set var="count" value="${count + 1 }"></c:set>
							...
							<td><img alt="hinhSP" style="width: 100px" src="../assets/img/product/${dh.hinhAnh}"></td> 
							<td style="width: 510px">${dh.tenSP}</td> 
							<td>${dh.gia}.000 đ</td>
							<td>${dh.soLuong}</td> 
							<td>${dh.tong}00 đ</td> 
						</tr> 
					...
					<a href="<c:url value="/startbootstrap-sb-admin-2-master/manageOder?loai=oder&index=${index}"></c:url>"><button class="btn  btn-primary">Quay lại</button></a>
				</div> 
			</div> 
		</div>
