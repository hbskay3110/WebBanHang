...
<%@page import="model.ChiTiet_SanPham"%>
						...
						<div class="row">
							<div class="col-md-12">
								...
								<form class="form-horizontal"
									action="/WebsBanHang/startbootstrap-sb-admin-2-master/ThemSuaXoaSanPham?chucNang=Sua"
									method="post">
									<div class="form-group">
										<label class="control-label col-sm-2" >Mã sản phẩm:</label>
										<div class="col-sm-10">
											<input  class="form-control" id="pwd" name="maSP" placeholder="Nhập mã sản phẩm" value="${sp.maSP}">
										</div>
									...
									<div class="form-group">
										<label class="control-label col-sm-2" >Tên
											sản phẩm*:</label>
										<div class="col-sm-10"> 
											<input type="text" class="form-control" id="pwd" value="${sp.tenSP}"
									...
									<div class="form-group">
										<label class="control-label col-sm-2" for="pwd">Giá
											gốc:</label>
										<div class="col-sm-10">
											<input type="text" class="form-control" id="pwd" value="${sp.giaBanSP}"
												name="priceOld" placeholder="Nhập giá gốc">
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-sm-3" for="pwd">Giá bán*:</label>
										<div class="col-sm-10">
											<input type="text" class="form-control" id="pwd"  value="${sp.giaGiam}"
									...
									<div class="form-group">
										<label class="control-label col-sm-3" for="pwd">Số
											lượng nhập:</label>
										<div class="col-sm-10">
											<input type="text" class="form-control" id="pwd" value="${sp.soLuongNhap}"
									...
									<div class="form-group">
										<label class="control-label col-sm-2" for="pwd">Ảnh
											sản phẩm:</label>
										<div class="col-sm-10">
											<input type="text" class="form-control" id="pwd" value="${sp.hinhAnh}"
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" class="form-control" id="pwd" name="sale" value="${sp.sale}"
												placeholder="VD: 30">
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" class="form-control" id="pwd" value="${ncc.tenNCC}"
												name="nameSupplier">
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" class="form-control" id="pwd" value="${ct_sp.moTa}"
									...
									<div class="form-group" style="display: flex;">
										...
										<div class="col-sm-10">
											...
											<input type="radio"	class="col-sm-1" name="type" value="Áo thun">Áo thun
											<input type="radio"	class="col-sm-1" name="type" value="Đồ bộ">Đồ bộ
											<input type="radio"	class="col-sm-1" name="type" value="Chân Váy"> Chân Váy
											<input type="radio"	class="col-sm-1" name="type" value="Váy dài"> Váy dài
											<input type="radio"	class="col-sm-1" name="type" value="Đầm"> Đầm 
											<input type="radio"	class="col-sm-1" name="type" value="Quần dài"> Quần dài
											<input type="radio"	class="col-sm-1" name="type" value="Quần Jean">Quần Jean
										</div>
									</div>
									<div class="form-group" style="display: flex;">
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" class="form-control" id="pwd" value="${ct_sp.chatLieu}"
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" class="form-control" id="pwd" value="${ct_sp.kieuDang}"
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" class="form-control" id="pwd" value="${ct_sp.xuatXu}"
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" class="form-control" id="pwd" value="${ct_sp.phongCach}"
