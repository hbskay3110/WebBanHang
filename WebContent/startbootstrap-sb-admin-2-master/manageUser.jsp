				...
				<div class="panel panel-primary"> 
					...
					<table class="table table-hover" id="dev-table"> 
						...
						<c:set var="count" value="${count + 1 }"></c:set>
							...
							<td>${u.diaChi}</td> 
							<td>${u.quyen}</td> 
							<td><a href="<c:url value="/startbootstrap-sb-admin-2-master/ThemSuaXoaServerlet?id=${u.tenTaiKhoan}&chucNang=Xoa"></c:url>"><button class="btn btn-warning">Xóa</button></a></td>
							<td><a href="<c:url value="repairUser.jsp?id=${u.tenTaiKhoan}"></c:url>"><button class="btn btn-primary">Sửa</button></a></td>
						</tr> 
						</c:forEach>
				
					</tbody></table> 
					<a href="<c:url value="/startbootstrap-sb-admin-2-master/addUser.jsp"></c:url>"><button class="btn  btn-primary">Thêm tài khoản</button></a>
				</div> 
			</div> 
		</div>
