					...
					<div class="container " style="margin-top: var(- -header-height)">
						...
						<div class="row">
							<div class="col-md-12">
								...
								<form class="form-horizontal" action="/WebsBanHang/startbootstrap-sb-admin-2-master/ThemSuaXoaServerlet?chucNang=Them" method="get">
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" class="form-control" id="pwd" name="NameKH"
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" class="form-control" id="pwd" name="telephone"
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="date" class="form-control" id="pwd" name="dayOfBith">
										</div>
									</div>
									<div class="form-group">
