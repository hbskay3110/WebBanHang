				...
				<div class="row sm-gutter app_content">
					<div class="col l-2 m-0 c-0 ">
						<nav class="category">
							...
							<ul class="category-list">
								...
								<a href="/WebsBanHang/renderSP"	class="category-item__link">Tất Cả</a></li>
					...
					<div class="col l-10 m-12 c-12">
						<div class="home-filter hide-on-mobile-tablet">
							...
							<div class="select-input">
								...
								<span class="select-input__label">Giá</span> <i
									class="select-input__icon fas fa-chevron-down"></i>
								<ul class="select-input__list">
									<li class="select-input__item"><a href="<c:url value="/SearchSP?attribute=GiaDaGiam&proviso=ASC"></c:url>"
										class="select-input__link select-input__link--up">Giá:
											Thấp đến cao</a></li>
									<li class="select-input__item"><a href="<c:url value="/SearchSP?attribute=GiaDaGiam&proviso=DESC"></c:url>"
							...
							<div class="home-filter__page">
								...
								<c:if test="${index gt 1}">
									...
									<a href="<c:url value="renderSP?index=${index -1}"></c:url>"
						...
						<nav class="mobile-category">
							<ul class="mobile-category__list">
								<c:forEach items="${listLoai}" var="l">
									...
									class="category-item__link">${l}</a></li>
								</c:forEach>
									...
									<div class="col l-2-4 m-4 c-6">
										<div class="home-product-wrap">
											<a class="home-produt-item"
												...
												href="<c:url value="/product/productDetail?maSP=${i.maSP}"></c:url>">
						...
						<ul class="panigation home-product-panigation">
							...
							<a href="<c:url value="renderSP?index=${index -1}"></c:url>" class="panigation-item__link">
							...
							<c:forEach begin="1" end="${endPage}" var="o">
								...
								<li class="panigation-item" ">
								<a  href="renderSP?index=${o}" class="panigation-item__link" id="${o}">${o}</a>
								</li>
							</c:forEach>
							<li class="panigation-item">
							<c:if test="${index lt endPage}">
							...
							<a href="#"
								class="panigation-item__link"> 
								<iclass="panigation-item__icon fas fa-angle-right"></i>
							</a>
							</c:if>
							</li>
						</ul>
...
<script>
	...
	Vadilator({
		...
		rules : [
				...
				Vadilator.ischekExist('#email',
						'Email hoặc số điện thoại đã tồn tại'),
				Vadilator.isRequired('#pass'), Vadilator.minLength('#pass', 6),
