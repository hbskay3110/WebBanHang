                                ...
                                <div class="table-content table-responsive">
                                    <table class="table">
                                        ...
                                        <c:forEach items="${sessionScope.cart}" var="item" >
                                            <tr>
                                                <td class="plantmore-product-thumbnail thumbnail"><a href="#"><img
                                                            src="../assets/img/product/${item.value.hinhAnh}" alt=""></a></td>
                                                <td class="plantmore-product-name"><a href="#">${item.value.tenSP}</a></td>
                                                <td class="plantmore-product-price"><span class="amount">${item.value.gia}.000
                                                        ₫</span></td>
                                                <td class="plantmore-product-quantity">
                                                    <input value="${item.value.soLuong}" type="number">
                                                </td>
                                                <td class="product-subtotal"><span class="amount">${item.value.tong}00 ₫</span>
                                                </td>
                                                <td class="plantmore-product-remove"><a href="<c:url value="/product/CartServlet?maSP=${item.value.maSP}&action=Xoa"></c:url>"><i
                                                    ...
                                                    <div class="coupon-all" style="margin: 0;">
                                                        <div class="coupon">
                                                            ...
                                                            <input id="coupon_code" class="input-text"
                                                                name="coupon_code" value="" placeholder="<fmt:message key= "assets.Disc" bundle="${language}"></fmt:message>"
                                                                type="text">
                                                            <input class="continue-btn btn-primary" name="apply_coupon" value="<fmt:message key= "assets.Use" bundle="${language}"></fmt:message>"
                                                                type="submit">
                                                        </div>
                                                    </div>
                                                </li>
                                                <li><fmt:message key= "assets.Summs" bundle="${language}"></fmt:message> <span>${sessionScope.total}00 ₫</span></li>
                                            </ul>
